...
function drawScene() {
    ...
    // move the camera
    mat4.translate(app.mvMatrix, app.mvMatrix, [0, 0, -100]);
    //mat4.rotate(app.mvMatrix, app.mvMatrix, app.time * 0.25 * Math.PI, [0, 1, 0]);
    // set up the scene
    mvPushMatrix();
    drawObject(app.models.bottle);
    mvPopMatrix();
    mat4.translate(app.mvMatrix, app.mvMatrix, [5.5, 0, 0]);
    mvPushMatrix();
    drawObject(app.models.bottle);
    mvPopMatrix();
    mat4.translate(app.mvMatrix, app.mvMatrix, [-2.75, 17.3, 0]);
    mvPushMatrix();
    drawObject(app.models.bottle);
    mvPopMatrix();
}
